...
public class TestCalsses {
    ...
    public void BracketChecker() {
        assertTrue(BracketChecker.areBracecketCorrect("(([]()){})"));

    }

    @Test
    public void BracketChecker2() {
        assertTrue(BracketChecker.areBracecketCorrect("(())"));
    }

    @Test
    public void BracketChecker3() {
        assertTrue(BracketChecker.areBracecketCorrect("(())[][][]"));
    }

    @Test
    public void BracketChecker4() {
        assertFalse(BracketChecker.areBracecketCorrect("(())[]][[][]"));
    }
